...
male2<-read_excel("WPP2019_INT_F03_2_POPULATION_BY_AGE_ANNUAL_MALE.xlsx", sheet=2,skip=16)%>%
  filter(`Reference date (as of 1 July)`<=2050 & `Reference date (as of 1 July)`>2020)%>%
...
write.csv(pop,"PopulationsAge20_2050.csv", row.names = F)
